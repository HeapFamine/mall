...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="img/productSingle/${p.firstProductImage.id}.png" class="bigImg">
        <div class="smallImageDiv">
            <c:forEach items="${p.productSingleImages}" var="pi">
                <img src="img/productSingle_small/${pi.id}.png" bigImageURL="img/productSingle/${pi.id}.png" class="smallImage">
            </c:forEach>
        </div>
